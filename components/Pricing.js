      ...
      <div className="max-w-screen-xl  px-6 sm:px-8 lg:px-16 mx-auto flex flex-col w-full text-center justify-center">
        <div className="flex flex-col w-full">
          <ScrollAnimationWrapper>
            ...
            >
              Introducing the roadmap leading to the initial traction growth stage and the high growth stage.
            </motion.p>
          </ScrollAnimationWrapper>
          <div className="grid grid-flow-row sm:grid-flow-col grid-cols-1 sm:grid-cols-3 gap-4 lg:gap-12 py-8 lg:py-12 px-6 sm:px-0 lg:px-6">
            <ScrollAnimationWrapper className="flex justify-center">
              ...
              >
                ...
                <ul className="flex flex-col list-inside pl-6 xl:pl-0 items-start justify-start text-left text-black-500 flex-grow">
                  ...
                  Marketing for primary incineration before launch
                  </li>
                  <li className="relative check custom-list my-2">
                  ...
                  <li className="relative check custom-list my-2">
                  Listing commemorative marketing and AirDrop
                  </li>
                </ul>
            ...
            <ScrollAnimationWrapper className="flex justify-center">
              ...
              <ul className="flex flex-col list-inside pl-6 xl:pl-0 items-start justify-start text-left text-black-500 flex-grow">
                ...
                20,000 Instagram Followers Target
                5,000 Telegram Me
                </li>
                <li className="relative check custom-list my-2">
                Establishment of donation voting system
                </li>
                <li className="relative check custom-list my-2">
                Secondary incineration and donation
                </li>
              </ul>
              {/* <div className="flex flex-col w-full justify-center mb-8 flex-none mt-12">
                <p className="text-2xl text-black-600 text-center mb-4 ">
          ...
          <ScrollAnimationWrapper>
            <motion.h3
              ...
              className="text-2xl sm:text-3xl lg:text-4xl font-medium text-black-600 leading-relaxed w-9/12 sm:w-6/12 lg:w-4/12 mx-auto">
               Donation network spanning around the world
            </motion.h3>
            <motion.p className="leading-normal  mx-auto my-2 w-10/12 sm:w-7/12 lg:w-6/12" variants={scrollAnimation}>
              See Burn2Give If you are curious about where donations are currently Donation place
            </motion.p>
          </ScrollAnimationWrapper>
          <ScrollAnimationWrapper>
